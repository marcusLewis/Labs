...
public class SolrDownload {
    ...
    private static final String ANO_MES = "201409";
    
    
    /* PROD */
    private static final String QUERY = "monthTS%3A" + ANO_MES + "+AND+-origemBusca_parameter%3Aanuncios_similares+AND+-origemBusca_parameter%3Aanuncios_recentes"; // %3A = :
    
    //private static final String URL_IMOVEIS = "http://10.240.64.104:8080/solr/pense-imoveis-log_shard1_replica4/select?q=" + QUERY + "&rows=1&wt=xml&indent=true&facet=true&facet.field=q_facet&facet.limit=1000000&facet.mincount=5";
    private static final String URL_IMOVEIS = "http://localhost:18080/solr/pense-imoveis-log-bkp2/select?q=" + QUERY + "&rows=1&wt=xml&indent=true&facet=true&facet.field=q_facet&facet.limit=1000000&facet.mincount=5";
