...
public class SolrDownload {
    ...
    private static final String URL_CARROS_SHARD_1 = "http://10.240.64.104:8080/solr/pense-carros-log_shard-1_replica1/select?q=monthTS%3A" + ANO_MES + "&rows=1&wt=xml&indent=true&facet=true&facet.field=q_facet&facet.limit=1000000&facet.mincount=1";
    private static final String URL_CARROS_SHARD_2 = "http://10.240.64.104:8080/solr/pense-carros-log_shard-2_replica1/select?q=monthTS%3A" + ANO_MES + "&rows=1&wt=xml&indent=true&facet=true&facet.field=q_facet&facet.limit=1000000&facet.mincount=1";
    
    
    
    private static final String FILE_IMOVEIS = "consultas_imoveis.xml";
    
    private static final String FILE_CARROS_SHARD_1 = "consultas_carros_shard1.xml";
    private static final String FILE_CARROS_SHARD_2 = "consultas_carros_shard2.xml";
    

    
    
    public static void main(String[] args) throws Exception {
        processar(URL_CARROS_SHARD_1, FILE_CARROS_SHARD_1);
        processar(URL_CARROS_SHARD_2, FILE_CARROS_SHARD_2);
